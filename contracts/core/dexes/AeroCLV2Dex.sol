...
// constants and types
import {AeroCLV2DexStorage} from "../storage/AeroCLV2Dex.sol";

contract AeroCLV2Dex is Ownable, ILiquidityDex, AeroCLV2DexStorage {
    ...
    function doSwap(
        ...
        return ISwapRouter(Addresses.aeroCLV2Router).exactInput(param);
    }
